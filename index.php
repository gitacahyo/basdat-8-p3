...
<body>
    <form method="post">
    <div class="login">
    <h1 class="teal"> <center> Halaman Login Jo&Co </center> </h1>
    ...
    <a class="teal"> <b> <center> Belum Mendaftar? </center> </b> </a>
    <p class="btn">
        <button class="btn first" type="submit" name="login"> Daftar </button> <br> <br>
        </form>
